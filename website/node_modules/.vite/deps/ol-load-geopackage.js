...
import {
  Vector_default
} from "./chunk-VW6FT7GO.js";
import "./chunk-R57OP4GZ.js";
import "./chunk-66USCJXI.js";
import "./chunk-RW3V7S4F.js";
import {
  Feature_default as Feature_default2,
  transformGeometryWithOptions
} from "./chunk-5GX5M6N2.js";
import "./chunk-WHOWR7F2.js";
import {
  Feature_default
} from "./chunk-WQIHMIOM.js";
import {
...
} from "./chunk-WBJADSKJ.js";
import "./chunk-JFXZSSOM.js";
import {
  Point_default,
  Polygon_default
} from "./chunk-CHSQSYC6.js";
import "./chunk-NZ5CPGGM.js";
import "./chunk-OEKQUCO6.js";
import {
  SimpleGeometry_default
} from "./chunk-53WBEOAC.js";
import "./chunk-YGUWW4EG.js";
import {
  get
} from "./chunk-Y4UTQI34.js";
import "./chunk-54BTDBAD.js";
import "./chunk-74R7PWPR.js";
import "./chunk-QFCIXVZ3.js";
import "./chunk-Z3W3A6XM.js";
...
// node_modules/ol-load-geopackage/dist/ol-load-geopackage.js
...
// node_modules/ol-load-geopackage/dist/ol-load-geopackage.js
var sql_js_version = package_default.version;
var promiseSqlWasmLoaded;
function initSqlJsWasm(sqlJsWasmDir) {
  if (sqlJsWasmDir === void 0) {
    sqlJsWasmDir = "";
  }
  promiseSqlWasmLoaded = (0, import_sql.default)({
...
function loadGpkg(gpkgFile, displayProjection) {
  if (promiseSqlWasmLoaded === void 0) {
    throw new Error("SQL WASM loading has not started; did you forget to run initSqlJsWasm() first?");
  }
  if (!get(displayProjection)) {
    throw new Error("Missing requested display projection [" + displayProjection + "] - can be added beforehand with ol/proj/proj4");
  }
  var gpkgReadPromise = readRawGpkg(gpkgFile);
  return Promise.allSettled([promiseSqlWasmLoaded, gpkgReadPromise]).then(
    (results) => {
    ...
    oReq.onreadystatechange = function() {
      if (this.readyState == 4) {
        ...
        if (this.status === 200 && gpkgArrayBuffer) {
          ...
          fail(new Error(
            "Requested GPKG file could not be loaded: " + gpkgFile
          ));
        }
      }
    };
...
function processGpkgData(loadedGpkgFile, gpkgArrayBuffer, sqlWasm, displayProjection) {
  var db;
  var dataFromGpkg = {};
  var sldsFromGpkg = {};
  ...
  try {
    ...
    throw new Error(
      'Unable to extract feature tables from OGC GeoPackage file "' + loadedGpkgFile + '":\n' + err
    );
  }
  stmt = db.prepare(`
  ...
  for (let table of featureTableNames) {
    ...
    let vectorSource = new Vector_default();
...
//# sourceMappingURL=ol-load-geopackage.js.map
